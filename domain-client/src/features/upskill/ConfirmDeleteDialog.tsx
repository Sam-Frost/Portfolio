...
// Same shape as components/LeaveDomainDialog.tsx, parameterized for reuse
// across topic and subtopic deletion.
export function ConfirmDeleteDialog({ title, message, onCancel, onConfirm }: ConfirmDeleteDialogProps) {
