...
func (h *Handler) Register(mux *http.ServeMux) {
	mux.HandleFunc("GET /api/document-labels", h.list)
	mux.HandleFunc("POST /api/document-labels", h.create)
	mux.HandleFunc("PATCH /api/document-labels/{id}", h.update)
	mux.HandleFunc("DELETE /api/document-labels/{id}", h.delete)
}
