// Package documentlabel owns the label set used by the Document Storage
// feature. It's a deliberate copy of internal/label rather than a shared
// package: the two label sets are managed independently (different Settings
// sections, different tables) and keeping them separate means neither
// feature can reach into the other's storage.
