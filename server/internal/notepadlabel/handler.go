...
func (h *Handler) Register(mux *http.ServeMux) {
	mux.HandleFunc("GET /api/notepad-labels", h.list)
	mux.HandleFunc("POST /api/notepad-labels", h.create)
	mux.HandleFunc("PATCH /api/notepad-labels/{id}", h.update)
	mux.HandleFunc("DELETE /api/notepad-labels/{id}", h.delete)
}
